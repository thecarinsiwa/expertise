...
MySQL schema in English for the Expertise platform.
...
| 3 | Project management | `portfolio`, `programme`, `project`, `project_phase`, `task`, `sub_task`, `deliverable`, `milestone`, `project_budget`, `project_resource`, `project_assignment` |
| 4 | Mission management | `mission`, `mission_type`, `mission_status`, `mission_order`, `objective`, `mission_plan`, `mission_report`, `mission_expense`, `mission_assignment` |
| 5 | Communication | `channel`, `conversation`, `message`, `notification`, `announcement`, `comment`, `attachment`, `communication_history` |
