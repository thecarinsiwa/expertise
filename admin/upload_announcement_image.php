<?php
/**
 * Upload d'images pour le contenu des annonces (Summernote).
 * Retourne l'URL relative pour insertion dans l'éditeur (depuis l'admin : ../uploads/announcements/...).
 */
...
$fileName = 'ann_' . date('Ymd_His') . '_' . substr(uniqid(), -6) . '.' . $ext;
...
// URL relative depuis les pages admin (ex: announcements.php est dans /admin/)
echo json_encode(['url' => '../uploads/announcements/' . $fileName]);
